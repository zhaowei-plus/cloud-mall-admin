...
export default () => {
  ...
  const fetchCategories = () => {
    http.get('dataCenter/group/categories', { regionCode }).then(res => {
  ...
  return (
    <Layout>
      <Content wrapperClassName="group-data">
        <div className="info">
          <label className="info__title">集团数据</label>
        ...
        <Statistics regionCode={regionCode} url="dataCenter/group/statistics" />
        <div className="view">
          ...
          <div className="view__content">
            ...
            <ViewChart
              ...
              exportDataType={20022}
              url="dataCenter/group/info"
              listUrl="dataCenter/group/list"
              exportUrl="/cmmc-report/report-ops/cmmc/org/stat/trend_detail_export"
            />
          </div>
        </div>
      </Content>
